function [OutputCollection] = sigmaa003_2023_prod(spy_price,Ivolcurve1stm,Ivolcurve2ndm,Vix_dat,ExpiryDate,Datestamp,TradeOptionType,OptionMoneyness,dynamic_weight,Vix_Thld,Leverge_step)
...
leverage_ts=roundlookup_prod(Vix_dat,Vix_Thld,Leverge_step);
...
if i==1
    ...
    Daily_PNL(i)=No_contract(i-1)*PutOpt_pnl(i)+Trading_cost(i); % PNL of a portfolio after cost
